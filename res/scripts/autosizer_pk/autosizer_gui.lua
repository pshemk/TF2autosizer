...
local function buildMainWindow()
    ...
    local deleteModelCacheButton = api.gui.comp.Button.new(api.gui.comp.TextView.new("Delete model cache"), false)
    deleteModelCacheButton:onClick(function () 
        sendEngineCommand("asrDeleteModelCache")
    end)
    ...
    debugTable:addRow({deleteModelCacheButton})
